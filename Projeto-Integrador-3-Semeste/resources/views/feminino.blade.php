                ...
                <div class="product-grid listing">
                    <script>
                        ...
                        const listingProducts = [
                            { name: 'Brinco de Ouro 10k', price: '2.125,50', original: '2.632,50', rating: '5.0/5', img: `${assetBase}img/anel1.png` },
                            { name: 'Anel de Ouro 20k', price: '1.545,55', rating: '4.0/5', img: `${assetBase}img/colar1.png` },
                            { name: 'Colar de Ouro 85k', price: '8.000,50', rating: '3.8/5', img: `${assetBase}img/anel2.png` },
                        ];
                        for (let i = 0; i < 3; i++) {
