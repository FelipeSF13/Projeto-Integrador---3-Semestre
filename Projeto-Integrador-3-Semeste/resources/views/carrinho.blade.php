...
<body>
    ...
    <main class="container">
        <nav class="breadcrumb">
            <a href="index.html">Página Inicial</a>
            <span>&gt;</span>
            <a href="detalhe-produto.html">Anel de Ouro - Pingente Verde Esmeralda</a>
             <span>&gt;</span>
            ...
            <section class="cart-items">
                <article class="cart-item" data-price="145.50">
                    <div class="item-details">
                        <img src="img/anel1.png" alt="Colar de Ouro">
                        <div>
                            <h2>Colar de Ouro</h2>
                            <p>Tamanho: 45 cm</p>
                            <p>Cor: Ouro</p>
                ...
                <article class="cart-item" data-price="180.45">
                    <div class="item-details">
                       <img src="img/anel2.png" alt="Colar de Ouro">
                        <div>
                            <h2>Colar de Ouro</h2>
                            <p>Tamanho: 45 cm</p>
                            <p>Cor: Ouro</p>
                 ...
                 <article class="cart-item" data-price="240.25">
                    <div class="item-details">
                        <img src="img/colar2.png" alt="Colar de Ouro">
                        <div>
                            <h2>Colar de Ouro</h2>
                            <p>Tamanho: 40 cm</p>
                            <p>Cor: Ouro</p>
