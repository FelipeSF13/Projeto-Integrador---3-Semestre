...
<body>
    ...
    <div class="top-bar"><span>Faça login e ganhe 20% em sua primeira compra. <a href="{{ route('cadastro') }}">Registre-se</a></span>
    ...
    <main class="container">
        ...
        <div class="auth-page-container">
            <form class="auth-form" id="loginForm">
                ...
                <p class="auth-link"> É administrador? <a href="{{ route('admin.dashboard') }}"> Entre no portal!</a></p>
                <p class="auth-link">Não tem conta? <a href="{{ route('cadastro') }}">Cadastre-se!</a></p>
