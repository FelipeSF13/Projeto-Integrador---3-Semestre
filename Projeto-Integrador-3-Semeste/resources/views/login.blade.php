...
<body>
    ...
    <div class="top-bar"><span>Faça login e ganhe 20% em sua primeira compra. <a href="cadastro.html">Registre-se</a></span>
    ...
    <main class="container">
        ...
        <div class="auth-page-container">
            <form class="auth-form" id="loginForm">
                ...
                <p class="auth-link"> É administrador? <a href="admin_dashboard.html"> Entre no portal!</a></p>
