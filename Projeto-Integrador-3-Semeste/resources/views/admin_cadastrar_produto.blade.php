    ...
    <main class="admin-main container">
        <div class="admin-card"> 
            ...
            <nav class="admin-tabs">
                <a href="{{ route('admin.produtos') }}">Em estoque</a> 
                <a href="{{ route('admin.usuarios') }}">Usuários</a> 
                <a href="{{ route('admin.cadastrar-produto') }}" class="active">Cadastrar Produtos</a> 
            </nav>
            ...
            <form action="#" method="POST" enctype="multipart/form-data" class="admin-form product-form-layout">
                ...
                <div class="form-actions">
                     ...
                     <a href="{{ route('admin.produtos') }}" class="btn btn-secondary">Cancelar</a> 
                </div>
            </form>
        </div>
    </main>
