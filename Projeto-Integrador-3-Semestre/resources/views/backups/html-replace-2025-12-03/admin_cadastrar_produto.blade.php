...
<body class="admin-body-bg">
    ...
    <main class="admin-main container">
        <div class="admin-card">
            ...
            @if(session('success'))
                <div class="alert alert-success" role="status" style="margin-top:12px">{{ session('success') }}</div>
            @endif
            ...
            <form action="{{ route('adm-cadastro.save') }}" method="POST" enctype="multipart/form-data" class="admin-form product-form-layout">
                @csrf
